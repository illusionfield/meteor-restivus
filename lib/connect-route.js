// This code is derived from the last updated version of https://github.com/baryshev/connect-route/blob/master/lib/connect-route.js
...
class Router {
	...
	match(method, url) {
		var
			parts = decodeURI(url).split('?', 1)[0].replace(separator, '').split('/'), result = { handler: undefined, route: undefined, params: {} }, current, i, length;
