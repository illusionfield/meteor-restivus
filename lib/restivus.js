  ...
  _initAuth() {
    ...
    this.addRoute('login', {authRequired: false}, {
      post() {
        ...
        const extra = 'function' === typeof self._config.onLoggedIn && self._config.onLoggedIn.call(this);
        if(extra != null) {
    ...
    */
    return this.addRoute('logout', {authRequired: true}, {
      post() {
        ...
        const extra = 'function' === typeof self._config.onLoggedOut && self._config.onLoggedOut.call(this);
        if(extra != null) {
          response.data.extra = extra;
        }
        return response;
